        ...
        <Card>
          ...
          <form v-form="form">
            <div>
              ...
              <p v-if="validations.form.username.result&&validations.form.username.result.flg===false">
                {{validations.form.username.result.msg}}</p>
            </div>
            <div>
              用户名2：<input type="text" name="username2" v-lidate.input.username v-model="form.username2" @click="">
              <p v-if="validations.form.username2.result&&validations.form.username2.result.flg===false">
                {{validations.form.username2.result.msg}}</p>
            </div>
            <div>
              idCard：<input type="text" name="idCard" v-lidate.input v-model="form.idCard" @click="">
              <p v-if="validations.form.idCard.result&&validations.form.idCard.result.flg===false">
                {{validations.form.idCard.result.msg}}</p>
            </div>
            <div>
              电话：<input type="text" name="tel" v-lidate.change v-model="form.tel">
              <p v-if="validations.form.tel.result&&validations.form.tel.result.flg===false">
                {{validations.form.tel.result.msg}}</p>
            </div>
          ...
          <form v-form="form2">
            <div>
              ...
              <p v-if="validations.form2.username.result&&validations.form2.username.result.flg===false">
                {{validations.form2.username.result.msg}}</p>
            </div>
            <div>
              用户名2：<input type="text" name="username2" v-lidate.input.username v-model="form2.username2" @click="">
              <p v-if="validations.form2.username2.result&&validations.form2.username2.result.flg===false">
                {{validations.form2.username2.result.msg}}</p>
            </div>
            <div>
              idCard：<input type="text" name="idCard" v-lidate.input v-model="form2.idCard" @click="">
              <p v-if="validations.form2.idCard.result&&validations.form2.idCard.result.flg===false">
                {{validations.form2.idCard.result.msg}}</p>
            </div>
            <div>
              电话：<input type="text" name="tel" v-lidate.change v-model="form.tel">
              <p v-if="validations.form.tel.result&&validations.form.tel.result.flg===false">
